...
func NewTestAttachments() map[string]*gtsmodel.MediaAttachment {
	return map[string]*gtsmodel.MediaAttachment{
		...
		"remote_account_3_header": {
			...
			StatusID:  "",
			URL:       "http://localhost:8080/fileserver/01FHMQX3GAABWSM0S2VZEC2SWD/header/original/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
			RemoteURL: "http://fossbros-anonymous.io/attachments/small/a499f55b-2d1e-4acd-98d2-1ac2ba6d79b9.jpeg",
			CreatedAt: TimeMustParse("2022-06-09T13:12:00Z"),
			UpdatedAt: TimeMustParse("2022-06-09T13:12:00Z"),
			Type:      gtsmodel.FileTypeImage,
			...
			AccountID:         "01FHMQX3GAABWSM0S2VZEC2SWD",
			Description:       "tweet from thoughts of dog: i drank. all the water. in my bowl. earlier. but just now. i returned. to the same bowl. and it was. full again.. the bowl. is haunted",
			ScheduledStatusID: "",
			Blurhash:          "LARysgM_IU_3~pD%M_Rj_39FIAt6",
			Processing:        2,
			File: gtsmodel.File{
				Path:        "01FHMQX3GAABWSM0S2VZEC2SWD/attachment/original/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				ContentType: "image/jpeg",
				FileSize:    19310,
				UpdatedAt:   TimeMustParse("2022-06-09T13:12:00Z"),
			},
			Thumbnail: gtsmodel.Thumbnail{
				Path:        "01FHMQX3GAABWSM0S2VZEC2SWD/attachment/small/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				ContentType: "image/jpeg",
				FileSize:    20395,
				UpdatedAt:   TimeMustParse("2022-06-09T13:12:00Z"),
				URL:         "http://localhost:8080/fileserver/01FHMQX3GAABWSM0S2VZEC2SWD/header/small/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				RemoteURL:   "http://fossbros-anonymous.io/attachments/small/a499f55b-2d1e-4acd-98d2-1ac2ba6d79b9.jpeg",
			},
			Avatar: FalseBool(),
			Header: TrueBool(),
