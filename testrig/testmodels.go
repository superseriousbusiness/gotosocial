...
func NewTestAttachments() map[string]*gtsmodel.MediaAttachment {
	return map[string]*gtsmodel.MediaAttachment{
		...
		"remote_account_1_header": {
			ID:        "01PFPMWK2FF0D9WMHEJHR07C3R",
			StatusID:  "",
			URL:       "http://localhost:8080/fileserver/01F8MH5ZK5VRH73AKHQM6Y9VNX/header/original/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
			RemoteURL: "http://fossbros-anonymous.io/attachments/small/a499f55b-2d1e-4acd-98d2-1ac2ba6d79b9.jpeg",
			CreatedAt: TimeMustParse("2022-06-09T13:12:00Z"),
			UpdatedAt: TimeMustParse("2022-06-09T13:12:00Z"),
			Type:      gtsmodel.FileTypeImage,
			...
			Processing:        2,
			File: gtsmodel.File{
				Path:        "01F8MH5ZK5VRH73AKHQM6Y9VNX/attachment/original/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				ContentType: "image/jpeg",
				FileSize:    19310,
				UpdatedAt:   TimeMustParse("2022-06-09T13:12:00Z"),
			},
			Thumbnail: gtsmodel.Thumbnail{
				Path:        "01F8MH5ZK5VRH73AKHQM6Y9VNX/attachment/small/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				ContentType: "image/jpeg",
				FileSize:    20395,
				UpdatedAt:   TimeMustParse("2022-06-09T13:12:00Z"),
				URL:         "http://localhost:8080/fileserver/01F8MH5ZK5VRH73AKHQM6Y9VNX/header/small/01PFPMWK2FF0D9WMHEJHR07C3R.jpeg",
				RemoteURL:   "http://fossbros-anonymous.io/attachments/small/a499f55b-2d1e-4acd-98d2-1ac2ba6d79b9.jpeg",
			},
			Avatar: FalseBool(),
			Header: TrueBool(),
