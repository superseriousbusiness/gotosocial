...
func NewTestFediPeople() map[string]vocab.ActivityStreamsPerson {
	...
	return map[string]vocab.ActivityStreamsPerson{
		...
		"https://misconfigured-instance.com/users/someone": newAPPerson(
			URLMustParse("https://misconfigured-instance.com/users/someone"),
			URLMustParse("https://misconfigured-instance.com/users/someone/following"),
			URLMustParse("https://misconfigured-instance.com/users/someone/followers"),
			URLMustParse("https://misconfigured-instance.com/users/someone/inbox"),
			nil,
			URLMustParse("https://misconfigured-instance.com/users/someone/outbox"),
			URLMustParse("https://misconfigured-instance.com/users/someone/collections/featured"),
			"someone",
			"Geoff Brando Someone",
			"hey I'm someone, your instance hasn't seen me yet uwu",
			URLMustParse("https://misconfigured-instance.com/@someone"),
			true,
			URLMustParse("https://misconfigured-instance.com/users/someone#main-key"),
			newPerson1Pub,
			nil,
			"image/jpeg",
			nil,
		...
		"https://misconfigured-instance.com/users/nobody": newAPPerson(
			URLMustParse("https://misconfigured-instance.com/users/nobody"),
			URLMustParse("https://misconfigured-instance.com/users/nobody/following"),
			URLMustParse("https://misconfigured-instance.com/users/nobody/followers"),
			URLMustParse("https://misconfigured-instance.com/users/nobody/inbox"),
			nil,
			URLMustParse("https://misconfigured-instance.com/users/nobody/outbox"),
			URLMustParse("https://misconfigured-instance.com/users/nobody/collections/featured"),
			"nobody",
			"Geoff Brando nobody",
			"hey I'm nobody, your instance hasn't seen me yet uwu",
			URLMustParse("https://misconfigured-instance.com/@nobody"),
			true,
			URLMustParse("https://misconfigured-instance.com/users/nobody#main-key"),
			newPerson1Pub,
			nil,
			"image/jpeg",
			nil,
