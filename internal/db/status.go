...
type Status interface {
	...
	// IsStatusPinnedBy checks if a given status has been pinned by a given account ID.
	IsStatusPinnedBy(ctx context.Context, status *gtsmodel.Status, accountID string) (bool, Error)
