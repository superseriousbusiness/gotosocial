...
type Timeline interface {
	...
	// GetTagTimeline fetches the tag timeline -- ie., posts and replies that are public.
	// It will use the given filters and try to return as many statuses as possible up to the limit.
	//
	// Statuses should be returned in descending order of when they were created (newest first).
	GetTagTimeline(ctx context.Context, accountID string, hashtag *gtsmodel.Tag, maxID string, sinceID string, minID string, limit int, local bool) ([]*gtsmodel.Status, Error)
