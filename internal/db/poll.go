...
type Poll interface {
	...
	// GetPollVotes ...
	GetPollVotes(ctx context.Context, pollID string, accountID string) ([]*gtsmodel.PollVote, error)

	// PutPollVote ...
	PutPollVote(ctx context.Context, vote *gtsmodel.PollVote)

	// DeletePollVoteByID ...
	DeletePollVoteByID(ctx context.Context, id string) error
}
