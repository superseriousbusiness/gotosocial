...
type Admin interface {
	...
	NewSignup(ctx context.Context, username, reason string, requireApproval bool, email, password string, signUpIP net.IP, locale, appID string, emailVerified, admin bool) (*gtsmodel.User, Error)
