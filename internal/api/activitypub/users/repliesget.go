...
func (m *Module) StatusRepliesGETHandler(c *gin.Context) {
	...
	resp, errWithCode := m.processor.FediStatusRepliesGet(apiutil.TransferSignatureContext(c), requestedUsername, requestedStatusID, page, onlyOtherAccounts, minID, c.Request.URL)
	if errWithCode != nil {
