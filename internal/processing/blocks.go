...
func (p *processor) BlocksGet(ctx context.Context, authed *oauth.Auth, maxID, sinceID string, limit int) (*apimodel.BlocksResponse, gtserror.WithCode) {
...
func (p *processor) packageBlocksResponse(accounts []*apimodel.Account, path, nextMaxID, prevMinID string, limit int) (*apimodel.BlocksResponse, gtserror.WithCode) {
