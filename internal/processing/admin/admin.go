...
type Processor interface {
	...
	EmojisGet(ctx context.Context, account *gtsmodel.Account, user *gtsmodel.User, domain string, includeDisabled bool, includeEnabled bool, shortcode string) ([]*apimodel.AdminEmoji, gtserror.WithCode)
