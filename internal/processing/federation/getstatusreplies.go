...
func (p *processor) GetStatusReplies(ctx context.Context, requestedUsername, requestedStatusID string, page, onlyOtherAccounts bool, minID string, requestURL *url.URL) (interface{}, gtserror.WithCode) {
