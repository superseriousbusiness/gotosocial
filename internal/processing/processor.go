...
type Processor interface {
	...
	*/
	...
	AdminEmojisGet(ctx context.Context, authed *oauth.Auth, domain string, includeDisabled bool, includeEnabled bool, shortcode string) ([]*apimodel.AdminEmoji, gtserror.WithCode)
