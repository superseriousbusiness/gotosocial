...
func (suite *FromFederatorTestSuite) TestProcessReplyMention() {
	...
	wssStream, errWithCode := suite.processor.StreamOpen(context.Background(), repliedAccount, stream.TimelineHome)
...
func (suite *FromFederatorTestSuite) TestProcessFave() {
	...
	wssStream, errWithCode := suite.processor.StreamOpen(context.Background(), favedAccount, stream.TimelineNotifications)
	suite.NoError(errWithCode)
...
func (suite *FromFederatorTestSuite) TestProcessFaveWithDifferentReceivingAccount() {
	...
	wssStream, errWithCode := suite.processor.StreamOpen(context.Background(), receivingAccount, stream.TimelineHome)
	suite.NoError(errWithCode)
...
func (suite *FromFederatorTestSuite) TestProcessFollowRequestLocked() {
	...
	wssStream, errWithCode := suite.processor.StreamOpen(context.Background(), targetAccount, stream.TimelineHome)
	suite.NoError(errWithCode)
