...
type Processor interface {
	...
	StatusesGet(ctx context.Context, requestingAccount *gtsmodel.Account, targetAccountID string, limit int, excludeReplies, excludeReblogs bool, maxID, minID string, pinned, mediaOnly, publicOnly bool) (*apimodel.PageableResponse, gtserror.WithCode)
	...
	WebStatusesGet(ctx context.Context, targetAccountID, maxID string) (*apimodel.PageableResponse, gtserror.WithCode)
