...
type AccountNote struct {
	...
	AccountID       string    `validate:"required,ulid" bun:"type:CHAR(26),unique:notesrctarget,notnull,nullzero"` // ID of the local account that created the note
	Account         *Account  `validate:"-" bun:"rel:belongs-to"`                                                  // Account corresponding to accountID
	TargetAccountID string    `validate:"required,ulid" bun:"type:CHAR(26),unique:notesrctarget,notnull,nullzero"` // Who is the target of this note?
