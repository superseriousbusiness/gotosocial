...
type Status struct {
	...
	ApprovedByURI            string             `bun:",nullzero"`                                                         // URI of *either* an Accept Activity, or a ReplyAuthorization or AnnounceAuthorization, which approves the Announce or Create Activity that this status was/will be attached to.
}
