...
type Account struct {
	...
	SharedInboxURI          *string          `validate:"-" bun:""`                                                                                                   // Address of this account's ActivityPub sharedInbox, if it has one. If we don't yet know, this will be nil. If it doesn't have one, will be an empty string.
