...
type Account struct {
	...
	MovedToURI              string           `bun:",nullzero"`                      // This account has moved to this account URI. Even if this field is set the move may not yet have been processed. Check `moved_at` for this.
