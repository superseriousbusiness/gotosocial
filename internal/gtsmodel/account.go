...
type Account struct {
	...
	PostFormat              string           `validate:"required_without=Domain,omitempty,oneof=plain markdown" bun:",nullzero"`                                     // What is the default format for posts written by this account (only for local accounts).
