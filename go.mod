...
require (
	...
	github.com/superseriousbusiness/exif-terminator v0.5.1-0.20231128115850-d1777e14d080
...
require (
	...
	github.com/superseriousbusiness/go-png-image-structure/v2 v2.0.0-SSB // indirect
