...
// DeserializeLikeApproval creates a LikeApproval from a map representation that
// has been unmarshalled from a text or binary format.
func DeserializeLikeApproval(m map[string]interface{}, aliasMap map[string]string) (*GoToSocialLikeApproval, error) {
	alias := ""
	aliasPrefix := ""
	...
	if typeValue, ok := m["type"]; !ok {
		...
		if typeName != "LikeApproval" {
			return nil, fmt.Errorf("\"type\" property is not of %q type: %s", "LikeApproval", typeName)
		}
		// Fall through, success in finding a proper Type
	} else if arrType, ok := typeValue.([]interface{}); ok {
		found := false
		for _, elemVal := range arrType {
			if typeString, ok := elemVal.(string); ok && strings.TrimPrefix(typeString, aliasPrefix) == "LikeApproval" {
				found = true
				break
			}
		}
		if !found {
			return nil, fmt.Errorf("could not find a \"type\" property of value %q", "LikeApproval")
		}
		// Fall through, success in finding a proper Type
	} else {
...
// GoToSocialLikeApprovalExtends returns true if the LikeApproval type extends
// from the other type.
func GoToSocialLikeApprovalExtends(other vocab.Type) bool {
...
// IsOrExtendsLikeApproval returns true if the other provided type is the
// LikeApproval type or extends from the LikeApproval type.
func IsOrExtendsLikeApproval(other vocab.Type) bool {
	if other.GetTypeName() == "LikeApproval" {
		return true
	}
	return LikeApprovalIsExtendedBy(other)
}

// LikeApprovalIsDisjointWith returns true if the other provided type is disjoint
// with the LikeApproval type.
func LikeApprovalIsDisjointWith(other vocab.Type) bool {
...
// LikeApprovalIsExtendedBy returns true if the other provided type extends from
// the LikeApproval type. Note that it returns false if the types are the
// same; see the "IsOrExtendsLikeApproval" variant instead.
func LikeApprovalIsExtendedBy(other vocab.Type) bool {
	// Shortcut implementation: is not extended by anything.
	return false
}

// NewGoToSocialLikeApproval creates a new LikeApproval type
func NewGoToSocialLikeApproval() *GoToSocialLikeApproval {
	typeProp := typePropertyConstructor()
	typeProp.AppendXMLSchemaString("LikeApproval")
	return &GoToSocialLikeApproval{
		JSONLDType: typeProp,
		alias:      "",
		unknown:    make(map[string]interface{}),
	}
...
func (this GoToSocialLikeApproval) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// IsExtending returns true if the LikeApproval type extends from the other type.
func (this GoToSocialLikeApproval) IsExtending(other vocab.Type) bool {
	return GoToSocialLikeApprovalExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this GoToSocialLikeApproval) JSONLDContext() map[string]string {
...
// LessThan computes if this LikeApproval is lesser, with an arbitrary but stable
// determination.
func (this GoToSocialLikeApproval) LessThan(o vocab.GoToSocialLikeApproval) bool {
...
func (this GoToSocialLikeApproval) Serialize() (map[string]interface{}, error) {
	m := make(map[string]interface{})
	typeName := "LikeApproval"
	if len(this.alias) > 0 {
		typeName = this.alias + ":" + "LikeApproval"
	}
	m["type"] = typeName
...
func (this *GoToSocialLikeApproval) SetActivityStreamsAltitude(i vocab.ActivityStreamsAltitudeProperty) {
	this.ActivityStreamsAltitude = i
}

// SetActivityStreamsAttachment sets the "attachment" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsAttachment(i vocab.ActivityStreamsAttachmentProperty) {
	this.ActivityStreamsAttachment = i
}

// SetActivityStreamsAttributedTo sets the "attributedTo" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsAttributedTo(i vocab.ActivityStreamsAttributedToProperty) {
	this.ActivityStreamsAttributedTo = i
}

// SetActivityStreamsAudience sets the "audience" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsAudience(i vocab.ActivityStreamsAudienceProperty) {
	this.ActivityStreamsAudience = i
}

// SetActivityStreamsBcc sets the "bcc" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsBcc(i vocab.ActivityStreamsBccProperty) {
	this.ActivityStreamsBcc = i
}

// SetActivityStreamsBto sets the "bto" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsBto(i vocab.ActivityStreamsBtoProperty) {
	this.ActivityStreamsBto = i
}

// SetActivityStreamsCc sets the "cc" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsCc(i vocab.ActivityStreamsCcProperty) {
	this.ActivityStreamsCc = i
}

// SetActivityStreamsContent sets the "content" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsContent(i vocab.ActivityStreamsContentProperty) {
	this.ActivityStreamsContent = i
}

// SetActivityStreamsContext sets the "context" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsContext(i vocab.ActivityStreamsContextProperty) {
	this.ActivityStreamsContext = i
}

// SetActivityStreamsDuration sets the "duration" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsDuration(i vocab.ActivityStreamsDurationProperty) {
	this.ActivityStreamsDuration = i
}

// SetActivityStreamsEndTime sets the "endTime" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsEndTime(i vocab.ActivityStreamsEndTimeProperty) {
	this.ActivityStreamsEndTime = i
}

// SetActivityStreamsGenerator sets the "generator" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsGenerator(i vocab.ActivityStreamsGeneratorProperty) {
	this.ActivityStreamsGenerator = i
}

// SetActivityStreamsIcon sets the "icon" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsIcon(i vocab.ActivityStreamsIconProperty) {
	this.ActivityStreamsIcon = i
}

// SetActivityStreamsImage sets the "image" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsImage(i vocab.ActivityStreamsImageProperty) {
	this.ActivityStreamsImage = i
}

// SetActivityStreamsInReplyTo sets the "inReplyTo" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsInReplyTo(i vocab.ActivityStreamsInReplyToProperty) {
	this.ActivityStreamsInReplyTo = i
}

// SetActivityStreamsLikes sets the "likes" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsLikes(i vocab.ActivityStreamsLikesProperty) {
	this.ActivityStreamsLikes = i
}

// SetActivityStreamsLocation sets the "location" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsLocation(i vocab.ActivityStreamsLocationProperty) {
	this.ActivityStreamsLocation = i
}

// SetActivityStreamsMediaType sets the "mediaType" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsMediaType(i vocab.ActivityStreamsMediaTypeProperty) {
	this.ActivityStreamsMediaType = i
}

// SetActivityStreamsName sets the "name" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsName(i vocab.ActivityStreamsNameProperty) {
	this.ActivityStreamsName = i
}

// SetActivityStreamsObject sets the "object" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsObject(i vocab.ActivityStreamsObjectProperty) {
	this.ActivityStreamsObject = i
}

// SetActivityStreamsPreview sets the "preview" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsPreview(i vocab.ActivityStreamsPreviewProperty) {
...
func (this *GoToSocialLikeApproval) SetActivityStreamsReplies(i vocab.ActivityStreamsRepliesProperty) {
	this.ActivityStreamsReplies = i
}

// SetActivityStreamsSensitive sets the "sensitive" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsSensitive(i vocab.ActivityStreamsSensitiveProperty) {
	this.ActivityStreamsSensitive = i
}

// SetActivityStreamsShares sets the "shares" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsShares(i vocab.ActivityStreamsSharesProperty) {
	this.ActivityStreamsShares = i
}

// SetActivityStreamsSource sets the "source" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsSource(i vocab.ActivityStreamsSourceProperty) {
	this.ActivityStreamsSource = i
}

// SetActivityStreamsStartTime sets the "startTime" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsStartTime(i vocab.ActivityStreamsStartTimeProperty) {
	this.ActivityStreamsStartTime = i
}

// SetActivityStreamsSummary sets the "summary" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsSummary(i vocab.ActivityStreamsSummaryProperty) {
	this.ActivityStreamsSummary = i
}

// SetActivityStreamsTag sets the "tag" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsTag(i vocab.ActivityStreamsTagProperty) {
	this.ActivityStreamsTag = i
}

// SetActivityStreamsTo sets the "to" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsTo(i vocab.ActivityStreamsToProperty) {
	this.ActivityStreamsTo = i
}

// SetActivityStreamsUpdated sets the "updated" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsUpdated(i vocab.ActivityStreamsUpdatedProperty) {
	this.ActivityStreamsUpdated = i
}

// SetActivityStreamsUrl sets the "url" property.
func (this *GoToSocialLikeApproval) SetActivityStreamsUrl(i vocab.ActivityStreamsUrlProperty) {
	this.ActivityStreamsUrl = i
}

// SetJSONLDId sets the "id" property.
func (this *GoToSocialLikeApproval) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *GoToSocialLikeApproval) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}

// VocabularyURI returns the vocabulary's URI as a string.
func (this GoToSocialLikeApproval) VocabularyURI() string {
	return "https://gotosocial.org/ns"
}

// helperJSONLDContext obtains the context uris and their aliases from a property,
// if it is not nil.
func (this GoToSocialLikeApproval) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
