...
type GoToSocialLikeAuthorization struct {
...
// DeserializeLikeAuthorization creates a LikeAuthorization from a map
// representation that has been unmarshalled from a text or binary format.
func DeserializeLikeAuthorization(m map[string]interface{}, aliasMap map[string]string) (*GoToSocialLikeAuthorization, error) {
	alias := ""
	aliasPrefix := ""
	...
	this := &GoToSocialLikeAuthorization{
		alias:   alias,
	...
	if typeValue, ok := m["type"]; !ok {
		...
		if typeName != "LikeAuthorization" {
			return nil, fmt.Errorf("\"type\" property is not of %q type: %s", "LikeAuthorization", typeName)
		}
		// Fall through, success in finding a proper Type
	} else if arrType, ok := typeValue.([]interface{}); ok {
		found := false
		for _, elemVal := range arrType {
			if typeString, ok := elemVal.(string); ok && strings.TrimPrefix(typeString, aliasPrefix) == "LikeAuthorization" {
				found = true
				break
			}
		}
		if !found {
			return nil, fmt.Errorf("could not find a \"type\" property of value %q", "LikeAuthorization")
		}
		// Fall through, success in finding a proper Type
	} else {
...
// GoToSocialLikeAuthorizationExtends returns true if the LikeAuthorization type
// extends from the other type.
func GoToSocialLikeAuthorizationExtends(other vocab.Type) bool {
...
// IsOrExtendsLikeAuthorization returns true if the other provided type is the
// LikeAuthorization type or extends from the LikeAuthorization type.
func IsOrExtendsLikeAuthorization(other vocab.Type) bool {
	if other.GetTypeName() == "LikeAuthorization" {
		return true
	}
	return LikeAuthorizationIsExtendedBy(other)
}

// LikeAuthorizationIsDisjointWith returns true if the other provided type is
// disjoint with the LikeAuthorization type.
func LikeAuthorizationIsDisjointWith(other vocab.Type) bool {
...
// LikeAuthorizationIsExtendedBy returns true if the other provided type extends
// from the LikeAuthorization type. Note that it returns false if the types
// are the same; see the "IsOrExtendsLikeAuthorization" variant instead.
func LikeAuthorizationIsExtendedBy(other vocab.Type) bool {
	// Shortcut implementation: is not extended by anything.
	return false
}

// NewGoToSocialLikeAuthorization creates a new LikeAuthorization type
func NewGoToSocialLikeAuthorization() *GoToSocialLikeAuthorization {
	typeProp := typePropertyConstructor()
	typeProp.AppendXMLSchemaString("LikeAuthorization")
	return &GoToSocialLikeAuthorization{
		JSONLDType: typeProp,
		alias:      "",
		unknown:    make(map[string]interface{}),
	}
...
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsAltitude() vocab.ActivityStreamsAltitudeProperty {
	return this.ActivityStreamsAltitude
}

// GetActivityStreamsAttachment returns the "attachment" property if it exists,
// and nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsAttachment() vocab.ActivityStreamsAttachmentProperty {
	return this.ActivityStreamsAttachment
}

// GetActivityStreamsAttributedTo returns the "attributedTo" property if it
// exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsAttributedTo() vocab.ActivityStreamsAttributedToProperty {
	return this.ActivityStreamsAttributedTo
}

// GetActivityStreamsAudience returns the "audience" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsAudience() vocab.ActivityStreamsAudienceProperty {
	return this.ActivityStreamsAudience
}

// GetActivityStreamsBcc returns the "bcc" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsBcc() vocab.ActivityStreamsBccProperty {
	return this.ActivityStreamsBcc
}

// GetActivityStreamsBto returns the "bto" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsBto() vocab.ActivityStreamsBtoProperty {
	return this.ActivityStreamsBto
}

// GetActivityStreamsCc returns the "cc" property if it exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsCc() vocab.ActivityStreamsCcProperty {
	return this.ActivityStreamsCc
}

// GetActivityStreamsContent returns the "content" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsContent() vocab.ActivityStreamsContentProperty {
	return this.ActivityStreamsContent
}

// GetActivityStreamsContext returns the "context" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsContext() vocab.ActivityStreamsContextProperty {
	return this.ActivityStreamsContext
}

// GetActivityStreamsDuration returns the "duration" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsDuration() vocab.ActivityStreamsDurationProperty {
	return this.ActivityStreamsDuration
}

// GetActivityStreamsEndTime returns the "endTime" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsEndTime() vocab.ActivityStreamsEndTimeProperty {
	return this.ActivityStreamsEndTime
}

// GetActivityStreamsGenerator returns the "generator" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsGenerator() vocab.ActivityStreamsGeneratorProperty {
	return this.ActivityStreamsGenerator
}

// GetActivityStreamsIcon returns the "icon" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsIcon() vocab.ActivityStreamsIconProperty {
	return this.ActivityStreamsIcon
}

// GetActivityStreamsImage returns the "image" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsImage() vocab.ActivityStreamsImageProperty {
	return this.ActivityStreamsImage
}

// GetActivityStreamsInReplyTo returns the "inReplyTo" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsInReplyTo() vocab.ActivityStreamsInReplyToProperty {
	return this.ActivityStreamsInReplyTo
}

// GetActivityStreamsLikes returns the "likes" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsLikes() vocab.ActivityStreamsLikesProperty {
	return this.ActivityStreamsLikes
}

// GetActivityStreamsLocation returns the "location" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsLocation() vocab.ActivityStreamsLocationProperty {
	return this.ActivityStreamsLocation
}

// GetActivityStreamsMediaType returns the "mediaType" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsMediaType() vocab.ActivityStreamsMediaTypeProperty {
	return this.ActivityStreamsMediaType
}

// GetActivityStreamsName returns the "name" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsName() vocab.ActivityStreamsNameProperty {
	return this.ActivityStreamsName
}

// GetActivityStreamsObject returns the "object" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsObject() vocab.ActivityStreamsObjectProperty {
	return this.ActivityStreamsObject
}

// GetActivityStreamsPreview returns the "preview" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsPreview() vocab.ActivityStreamsPreviewProperty {
	return this.ActivityStreamsPreview
}

// GetActivityStreamsPublished returns the "published" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsPublished() vocab.ActivityStreamsPublishedProperty {
	return this.ActivityStreamsPublished
}

// GetActivityStreamsReplies returns the "replies" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsReplies() vocab.ActivityStreamsRepliesProperty {
	return this.ActivityStreamsReplies
}

// GetActivityStreamsSensitive returns the "sensitive" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsSensitive() vocab.ActivityStreamsSensitiveProperty {
	return this.ActivityStreamsSensitive
}

// GetActivityStreamsShares returns the "shares" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsShares() vocab.ActivityStreamsSharesProperty {
	return this.ActivityStreamsShares
}

// GetActivityStreamsSource returns the "source" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsSource() vocab.ActivityStreamsSourceProperty {
	return this.ActivityStreamsSource
}

// GetActivityStreamsStartTime returns the "startTime" property if it exists, and
// nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsStartTime() vocab.ActivityStreamsStartTimeProperty {
	return this.ActivityStreamsStartTime
}

// GetActivityStreamsSummary returns the "summary" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsSummary() vocab.ActivityStreamsSummaryProperty {
	return this.ActivityStreamsSummary
}

// GetActivityStreamsTag returns the "tag" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsTag() vocab.ActivityStreamsTagProperty {
	return this.ActivityStreamsTag
}

// GetActivityStreamsTo returns the "to" property if it exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsTo() vocab.ActivityStreamsToProperty {
	return this.ActivityStreamsTo
}

// GetActivityStreamsUpdated returns the "updated" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsUpdated() vocab.ActivityStreamsUpdatedProperty {
	return this.ActivityStreamsUpdated
}

// GetActivityStreamsUrl returns the "url" property if it exists, and nil
// otherwise.
func (this GoToSocialLikeAuthorization) GetActivityStreamsUrl() vocab.ActivityStreamsUrlProperty {
	return this.ActivityStreamsUrl
}

// GetGoToSocialInteractingObject returns the "interactingObject" property if it
// exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetGoToSocialInteractingObject() vocab.GoToSocialInteractingObjectProperty {
	return this.GoToSocialInteractingObject
}

// GetGoToSocialInteractionTarget returns the "interactionTarget" property if it
// exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetGoToSocialInteractionTarget() vocab.GoToSocialInteractionTargetProperty {
	return this.GoToSocialInteractionTarget
}

// GetJSONLDId returns the "id" property if it exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetJSONLDId() vocab.JSONLDIdProperty {
	return this.JSONLDId
}

// GetJSONLDType returns the "type" property if it exists, and nil otherwise.
func (this GoToSocialLikeAuthorization) GetJSONLDType() vocab.JSONLDTypeProperty {
	return this.JSONLDType
}

// GetTypeName returns the name of this type.
func (this GoToSocialLikeAuthorization) GetTypeName() string {
	return "LikeAuthorization"
}

// GetUnknownProperties returns the unknown properties for the LikeAuthorization
...
func (this GoToSocialLikeAuthorization) GetUnknownProperties() map[string]interface{} {
	return this.unknown
}

// IsExtending returns true if the LikeAuthorization type extends from the other
// type.
func (this GoToSocialLikeAuthorization) IsExtending(other vocab.Type) bool {
	return GoToSocialLikeAuthorizationExtends(other)
}

// JSONLDContext returns the JSONLD URIs required in the context string for this
// type and the specific properties that are set. The value in the map is the
// alias used to import the type and its properties.
func (this GoToSocialLikeAuthorization) JSONLDContext() map[string]string {
...
// LessThan computes if this LikeAuthorization is lesser, with an arbitrary but
// stable determination.
func (this GoToSocialLikeAuthorization) LessThan(o vocab.GoToSocialLikeAuthorization) bool {
...
func (this GoToSocialLikeAuthorization) Serialize() (map[string]interface{}, error) {
	m := make(map[string]interface{})
	typeName := "LikeAuthorization"
	if len(this.alias) > 0 {
		typeName = this.alias + ":" + "LikeAuthorization"
	}
	m["type"] = typeName
...
func (this *GoToSocialLikeAuthorization) SetActivityStreamsAltitude(i vocab.ActivityStreamsAltitudeProperty) {
	this.ActivityStreamsAltitude = i
}

// SetActivityStreamsAttachment sets the "attachment" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsAttachment(i vocab.ActivityStreamsAttachmentProperty) {
	this.ActivityStreamsAttachment = i
}

// SetActivityStreamsAttributedTo sets the "attributedTo" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsAttributedTo(i vocab.ActivityStreamsAttributedToProperty) {
	this.ActivityStreamsAttributedTo = i
}

// SetActivityStreamsAudience sets the "audience" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsAudience(i vocab.ActivityStreamsAudienceProperty) {
	this.ActivityStreamsAudience = i
}

// SetActivityStreamsBcc sets the "bcc" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsBcc(i vocab.ActivityStreamsBccProperty) {
	this.ActivityStreamsBcc = i
}

// SetActivityStreamsBto sets the "bto" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsBto(i vocab.ActivityStreamsBtoProperty) {
	this.ActivityStreamsBto = i
}

// SetActivityStreamsCc sets the "cc" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsCc(i vocab.ActivityStreamsCcProperty) {
	this.ActivityStreamsCc = i
}

// SetActivityStreamsContent sets the "content" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsContent(i vocab.ActivityStreamsContentProperty) {
	this.ActivityStreamsContent = i
}

// SetActivityStreamsContext sets the "context" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsContext(i vocab.ActivityStreamsContextProperty) {
	this.ActivityStreamsContext = i
}

// SetActivityStreamsDuration sets the "duration" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsDuration(i vocab.ActivityStreamsDurationProperty) {
	this.ActivityStreamsDuration = i
}

// SetActivityStreamsEndTime sets the "endTime" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsEndTime(i vocab.ActivityStreamsEndTimeProperty) {
	this.ActivityStreamsEndTime = i
}

// SetActivityStreamsGenerator sets the "generator" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsGenerator(i vocab.ActivityStreamsGeneratorProperty) {
	this.ActivityStreamsGenerator = i
}

// SetActivityStreamsIcon sets the "icon" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsIcon(i vocab.ActivityStreamsIconProperty) {
	this.ActivityStreamsIcon = i
}

// SetActivityStreamsImage sets the "image" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsImage(i vocab.ActivityStreamsImageProperty) {
	this.ActivityStreamsImage = i
}

// SetActivityStreamsInReplyTo sets the "inReplyTo" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsInReplyTo(i vocab.ActivityStreamsInReplyToProperty) {
	this.ActivityStreamsInReplyTo = i
}

// SetActivityStreamsLikes sets the "likes" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsLikes(i vocab.ActivityStreamsLikesProperty) {
	this.ActivityStreamsLikes = i
}

// SetActivityStreamsLocation sets the "location" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsLocation(i vocab.ActivityStreamsLocationProperty) {
	this.ActivityStreamsLocation = i
}

// SetActivityStreamsMediaType sets the "mediaType" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsMediaType(i vocab.ActivityStreamsMediaTypeProperty) {
	this.ActivityStreamsMediaType = i
}

// SetActivityStreamsName sets the "name" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsName(i vocab.ActivityStreamsNameProperty) {
	this.ActivityStreamsName = i
}

// SetActivityStreamsObject sets the "object" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsObject(i vocab.ActivityStreamsObjectProperty) {
	this.ActivityStreamsObject = i
}

// SetActivityStreamsPreview sets the "preview" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsPreview(i vocab.ActivityStreamsPreviewProperty) {
...
func (this *GoToSocialLikeAuthorization) SetActivityStreamsReplies(i vocab.ActivityStreamsRepliesProperty) {
	this.ActivityStreamsReplies = i
}

// SetActivityStreamsSensitive sets the "sensitive" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsSensitive(i vocab.ActivityStreamsSensitiveProperty) {
	this.ActivityStreamsSensitive = i
}

// SetActivityStreamsShares sets the "shares" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsShares(i vocab.ActivityStreamsSharesProperty) {
	this.ActivityStreamsShares = i
}

// SetActivityStreamsSource sets the "source" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsSource(i vocab.ActivityStreamsSourceProperty) {
	this.ActivityStreamsSource = i
}

// SetActivityStreamsStartTime sets the "startTime" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsStartTime(i vocab.ActivityStreamsStartTimeProperty) {
	this.ActivityStreamsStartTime = i
}

// SetActivityStreamsSummary sets the "summary" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsSummary(i vocab.ActivityStreamsSummaryProperty) {
	this.ActivityStreamsSummary = i
}

// SetActivityStreamsTag sets the "tag" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsTag(i vocab.ActivityStreamsTagProperty) {
	this.ActivityStreamsTag = i
}

// SetActivityStreamsTo sets the "to" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsTo(i vocab.ActivityStreamsToProperty) {
	this.ActivityStreamsTo = i
}

// SetActivityStreamsUpdated sets the "updated" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsUpdated(i vocab.ActivityStreamsUpdatedProperty) {
	this.ActivityStreamsUpdated = i
}

// SetActivityStreamsUrl sets the "url" property.
func (this *GoToSocialLikeAuthorization) SetActivityStreamsUrl(i vocab.ActivityStreamsUrlProperty) {
	this.ActivityStreamsUrl = i
}

// SetGoToSocialInteractingObject sets the "interactingObject" property.
func (this *GoToSocialLikeAuthorization) SetGoToSocialInteractingObject(i vocab.GoToSocialInteractingObjectProperty) {
	this.GoToSocialInteractingObject = i
}

// SetGoToSocialInteractionTarget sets the "interactionTarget" property.
func (this *GoToSocialLikeAuthorization) SetGoToSocialInteractionTarget(i vocab.GoToSocialInteractionTargetProperty) {
	this.GoToSocialInteractionTarget = i
}

// SetJSONLDId sets the "id" property.
func (this *GoToSocialLikeAuthorization) SetJSONLDId(i vocab.JSONLDIdProperty) {
	this.JSONLDId = i
}

// SetJSONLDType sets the "type" property.
func (this *GoToSocialLikeAuthorization) SetJSONLDType(i vocab.JSONLDTypeProperty) {
	this.JSONLDType = i
}

// VocabularyURI returns the vocabulary's URI as a string.
func (this GoToSocialLikeAuthorization) VocabularyURI() string {
	return "https://gotosocial.org/ns"
}

// helperJSONLDContext obtains the context uris and their aliases from a property,
// if it is not nil.
func (this GoToSocialLikeAuthorization) helperJSONLDContext(i jsonldContexter, toMerge map[string]string) map[string]string {
	if i == nil {
		return toMerge
	}
