...
// exists, and nil otherwise.
func (this GoToSocialCanReply) GetGoToSocialAutomaticApproval() vocab.GoToSocialAutomaticApprovalProperty {
	return this.GoToSocialAutomaticApproval
}

// GetGoToSocialManualApproval returns the "manualApproval" property if it exists,
// and nil otherwise.
func (this GoToSocialCanReply) GetGoToSocialManualApproval() vocab.GoToSocialManualApprovalProperty {
...
func (this *GoToSocialCanReply) SetGoToSocialAutomaticApproval(i vocab.GoToSocialAutomaticApprovalProperty) {
	this.GoToSocialAutomaticApproval = i
}

// SetGoToSocialManualApproval sets the "manualApproval" property.
func (this *GoToSocialCanReply) SetGoToSocialManualApproval(i vocab.GoToSocialManualApprovalProperty) {
