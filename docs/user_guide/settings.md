...
Using this dropdown, you can choose what visibility level(s) of posts should be shown on the public web view of your profile, on thread web views, and served in your RSS feed (if you have enabled RSS).
